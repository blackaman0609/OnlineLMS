...
const Card = ({ thumbnail, title, category, price, id }) => {
  ...
  return (
    <div
      className="max-w-sm w-full bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 border-gray-300"
    ...
    >
      ...
      {/* <img 
        src={thumbnail ? `http://localhost:8000/${thumbnail}` : ""} 
        alt="" 
